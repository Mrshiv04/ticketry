				...
				<div className='hidden lg:block ml-auto'>
					<SignedIn>
						<div className='flex items-center gap-3'>
							...
							<Link href='/tickets'>
								<button
									className='bg-gray-100 text-gray-800 px-3 py-1.5 text-sm rounded-lg hover:bg-gray-200 transition 
				...
				<div className='lg:hidden w-full flex justify-center gap-3'>
					<SignedIn>
						...
						<Link href='/tickets' className='flex-1'>
							<button
								className='w-full bg-gray-100 text-gray-800 px-3 py-1.5 text-sm rounded-lg hover:bg-gray-200 transition 
                                    border border-gray-300'
							>
								My Tickets
							</button>
